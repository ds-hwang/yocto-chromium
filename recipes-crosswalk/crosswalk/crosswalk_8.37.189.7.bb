...
LICENSE_third_party/icu/source/data/brkitr = "ICU"
...
LICENSE_third_party/openssl = "OpenSSL"
...
LICENSE_third_party/webdriver = "Apache-2.0 & MIT & GPL-2.0"
...
LICENSE_tools/perf/page_sets/third_party/webrtc = "BSD"
...
LIC_FILES_CHKSUM = "file://${S}/xwalk/LICENSE;md5=c3d4637b0c8ceffb4111debb006efe58 \
    ...
    file://${S}/third_party/icu/LICENSE;md5=244ff2c1dabe90a1325a2d542f3007a3 \
    file://${S}/third_party/icu/source/data/brkitr/LICENSE;md5=4310729b8963f7fe20a1f094ebf336fd \
    ...
    file://${S}/third_party/liblouis/LICENSE;md5=0ecbf0ce03a787303ad819a4db03fc87 \
    ...
    file://${S}/third_party/libwebp/LICENSE;md5=26406932f2353f5702a5c045638010df \
    ...
    file://${S}/third_party/openssl/openssl/NOTICE;md5=f9a8f968107345e0b75aa8c2ecaa7ec8 \
    ...
    file://${S}/third_party/polymer/LICENSE;md5=324f45ce459ffd97e41d175a4e95a4be \
    ...
    file://${S}/third_party/webdriver/LICENSE;md5=f9272f569ef0fc3253ae84927632cba6 \
    ...
    file://${S}/tools/perf/page_sets/third_party/webrtc/LICENSE;md5=1002ed7b789589db95696cd2daa911d3 \
